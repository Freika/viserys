...
set :application,     "viserys"

# Сервер размещения проекта.
set :deploy_server,   "phosphorus.locum.ru"

# # whenever
# set :whenever_command, 'RAILS_ENV=production rvm use 2.1.5 do bundle exec whenever'
...
set :repository,    "git@github.com:Freika/viserys.git"
